	...
	public static class Generator
	{
		...
		*/
		...
		private sealed class FrequencyIntGenerator : AbstractGenerator<int>
		{
			...
			*/
			...
			public override void MoveNext()
			{
				if (buckets != null)
				{
					//Note, this is a way to generate a random int and float 
					//from just one random number
		...
		private sealed class UniformRandomFloatGenerator : AbstractGenerator<float>
		{
			...
			{
				return seed.HasValue ? new UniformRandomFloatGenerator(seed.Value) : new UniformRandomFloatGenerator();
			}
		}
