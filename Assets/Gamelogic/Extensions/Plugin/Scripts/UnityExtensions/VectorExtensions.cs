...
namespace Gamelogic.Extensions
{
	...
	public static class VectorExtensions
	{
		...
		{
			return new Vector2(
				GLMathf.Mod(thisVector.x, otherVector.x), 
				GLMathf.Mod(thisVector.y, otherVector.y));
		}
		...
		public static Vector3 HadamardMod(this Vector3 thisVector, Vector3 otherVector)
		{
			return new Vector3(
				GLMathf.Mod(thisVector.x, otherVector.x), 
				GLMathf.Mod(thisVector.y, otherVector.y),
				GLMathf.Mod(thisVector.z, otherVector.z));
		}
		...
		public static Vector4 HadamardMod(this Vector4 thisVector, Vector4 otherVector)
		{
			return new Vector4(
				...
				GLMathf.Mod(thisVector.y, otherVector.y),
				GLMathf.Mod(thisVector.z, otherVector.z),
				GLMathf.Mod(thisVector.w, otherVector.w));
		}
